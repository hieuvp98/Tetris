 ...
 * @author hoai
 */
public class JBlock2 extends BlockBase2 {

    private static final String URL = "images/xsquare2.png";

    public JBlock2(MultiController playArena, int mainCol, int mainRow) {
    ...
    public void init() {
        ...
        matrix[2] = new Square2(playArena, mainRow + 1, mainCol - 1);
        matrix[3] = new Square2(playArena, mainRow + 1, mainCol);
    ...
    public boolean checkTransformable() {
        switch (statusForm) {
            ...
            case 4: {
                ...
                SquareBase2[] squareBasesBottom = playArena.getRows2().get(mainRow + 1).getSquareBases();
                if (squareBasesTop[mainCol - 1] != null || squareBasesTop[mainCol] != null
                        || squareBasesBottom[mainCol - 1] != null || squareBasesBottom[mainCol] != null) {
                    return false;
                }
                break;
            }

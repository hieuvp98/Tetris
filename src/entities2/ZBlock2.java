 ...
 * @author hoai
 */
public class ZBlock2 extends BlockBase2 {

    private static final String URL = "images/xsquare7.png";

    public ZBlock2(MultiController playArena, int mainCol, int mainRow) {
        super(playArena, mainCol, mainRow);
    }

    @Override
    public void init() {
        matrix[0] = new Square2(playArena, mainRow - 1, mainCol - 1);
        matrix[1] = new Square2(playArena, mainRow - 1, mainCol);
